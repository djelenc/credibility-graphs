...
class NumericKnowledgeBase(graph: Graph<Int, CredibilityObject<Int, Int>>)
    : KnowledgeBase<Int, Int, CredibilityObject<Int, Int>>(graph) {

    constructor(text: String = "")
            : this(parseText(text, { Integer.parseInt(it) }, { Integer.parseInt(it) },
            { s, t, l -> CredibilityObject(s, t, l) }, graphMaker))

    override fun makeInstance(graph: Graph<Int, CredibilityObject<Int, Int>>): KnowledgeBase<Int, Int, CredibilityObject<Int, Int>> =
            NumericKnowledgeBase(graph)

    override fun isLessCredible(source: Int, target: Int, graph: KnowledgeBase<Int, Int, CredibilityObject<Int, Int>>): Boolean {
